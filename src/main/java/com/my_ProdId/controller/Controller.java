...
import com.my_ProdId.Service.ProductService;
...
public class Controller {
    ...
    public ResponseEntity<byte[]> getImageProductId(@PathVariable String productId) {
    ...
    public ResponseEntity<String> updateProduct(
        ...
        if (product1 != null)
            ...
            return new ResponseEntity<>("Failad to update" , HttpStatus.BAD_REQUEST);
    }
